...
export default function Galerie({products}){
    ...
    return (
        <Layout lang="ro">
            <HeadWithMeta
              title="Galerie | Millory"
              description="In galeria site-ului Millory puteti gasi poze cu oglinzi, dulapuri si alt mobilier din catalogul nostru de produse. Livram in Chisinau si restul Moldovei."
