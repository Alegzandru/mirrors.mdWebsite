...
export default function Contacte () {
    return(
        <Layout lang="en">
            <HeadWithMeta
              title="Contacts | Millory"
              description="You can see the products from the Millory website in our showroom on Ismail 98 street. To contact us, call +373 69 482 034."
