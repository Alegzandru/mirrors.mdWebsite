  ...
  return (
      <Layout lang="en" slug={productData[0].slug}>
          <HeadWithMeta
            ...
            description={`${productData[0].nameen} - one of the products from the "${productData[0].category.nameen}" collection on the Millory website. We ship to Chisinau and the rest of Moldova.`}
