...
export function DynamicProduct ({productData}) {
  ...
  return (
      <Layout lang="en" slug={productData[0].slug} stock={productData[0].inStock ? 'stoc' : 'comanda'}>
          <HeadWithMeta
            title={`${productData[0].nameen} | Millory`}
            description={`${productData[0].nameen} - unul dintre produsele din colectia "${productData[0].category.name}" de pe site-ul Millory. Livram in Chisinau si restul Moldovei.`}
