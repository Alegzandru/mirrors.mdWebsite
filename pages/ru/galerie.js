...
export default function Galerie({products}){
    ...
    return (
        <Layout lang="ru">
            <HeadWithMeta
              title="Галерея | Millory"
              description="В галерее сайта Millory вы можете найти фотографии зеркал, шкафов и другой мебели из нашего каталога продукции. Доставка в Кишинев и другие районы Молдовы."
