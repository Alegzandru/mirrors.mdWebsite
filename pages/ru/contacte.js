...
export default function Contacte () {
    return(
        <Layout lang="ru">
            <HeadWithMeta
              title="Контакты | Mirrors MD"
              description="Вы можете увидеть продукцию на сайте Mirrors MD в нашем выставочном зале на Ismail 98. Чтобы связаться с нами, позвоните по телефону +373 69 482 034."
