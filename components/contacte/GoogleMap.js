  ...
  return (
    <div ref={mapContainerRef} className="w-full max-w-screen relative">
      ...
      {!roDomain && <div className="absolute top-245px md:top-32 left-2">
        <a href="https://ul.waze.com/ul?place=ChIJU21Ydz58yUARFGrxGdirmJ0&ll=47.01925290%2C28.85239670&navigate=yes&utm_campaign=default&utm_medium=lm_share_location" target="_blank" className="flex items-center p-2 rounded-md bg-waze">
          <Image
